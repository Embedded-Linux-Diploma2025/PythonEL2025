...
def list_statistics(numbers):
    ...
    return {'sum': list_sum, 'average': list_sum/list_count, 'count': list_count}
...
def flatten_nested_list(nested_list):
    ...
    #     new_list += i
    return new_list
    # return sum(nested_list,[]) # search result
    # return [item for sublist in nested_list for item in sublist] # search result
